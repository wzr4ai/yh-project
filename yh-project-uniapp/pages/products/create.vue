  ...
  <view class="page">
    <view class="card">
      ...
      <view class="form-row">
        ...
        <input class="input" type="digit" v-model.number="form.base_cost_price" placeholder="进价" />
      </view>
      <view class="form-row">
        <view class="label">固定零售价</view>
        <input class="input" type="digit" v-model.number="form.fixed_retail_price" placeholder="为空则按系数" />
      </view>
      <view class="form-row">
